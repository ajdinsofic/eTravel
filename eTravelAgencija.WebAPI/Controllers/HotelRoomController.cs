...
{
    public class HotelRoomController : BaseCRUDController<Model.model.HotelRooms, BaseSearchObject, HotelRoomInsertRequest, HotelRoomUpdateRequest>
    {
        public HotelRoomController(ILogger<BaseCRUDController<Model.model.HotelRooms, BaseSearchObject, HotelRoomInsertRequest, HotelRoomUpdateRequest>> logger, IHotelRoomsService hotelRoomsService) : base(logger, hotelRoomsService){}
