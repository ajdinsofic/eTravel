...
{
    public class OfferHotelService : BaseCRUDService<Model.model.OfferHotels, BaseSearchObject, Database.OfferHotels, OfferHotelUpsertRequest, OfferHotelUpsertRequest>, IOfferHotelService
    {
