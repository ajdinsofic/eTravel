...
{
    /// <inheritdoc />
    public partial class mainFixingAndAddingMoreTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreatedAt", "Email", "EmailConfirmed", "FirstName", "LastLoginAt", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName", "isBlocked" },
                values: new object[,]
                {
                    { 1, 0, "66934109-5660-4cb8-b315-109434a8be30", new DateTime(2025, 11, 12, 13, 57, 22, 43, DateTimeKind.Utc).AddTicks(6382), "radnik@etravel.com", true, "Marko", null, "Radnik", false, null, "RADNIK@ETRAVEL.COM", "RADNIK", "AQAAAAIAAYagAAAAEBvrvFkwZ0017Kww2BdxnhnIrvoFBNH6yVjA4XwN1RReZt8jaxm6ZwI0s8iMORRO7Q==", "+38761111111", false, null, false, "radnik", false },
                    { 2, 0, "fd5c2982-9aa0-4030-be2e-09883e2eca9a", new DateTime(2025, 11, 12, 13, 57, 22, 106, DateTimeKind.Utc).AddTicks(125), "direktor@etravel.com", true, "Amir", null, "Direktor", false, null, "DIREKTOR@ETRAVEL.COM", "DIREKTOR", "AQAAAAIAAYagAAAAEKQGBktmmXagHlcMBER8Sao0nWrQxrj+l+PogKjufA6nANj+7YFMj6rrcj18IZS/ew==", "+38762222222", false, null, false, "direktor", false },
                    { 4, 0, "091553bb-be51-4086-a11a-c1532cf26be4", new DateTime(2025, 11, 12, 13, 57, 22, 173, DateTimeKind.Utc).AddTicks(9183), "korisnik@etravel.com", true, "Ajdin", null, "Korisnik", false, null, "KORISNIK@ETRAVEL.COM", "KORISNIK", "AQAAAAIAAYagAAAAEJJaAoMlQqaF6KCuggGxmE3xdwbjhe92lQPO3rdyhGfiC95CsX2T0pUsfH0KrURfAQ==", "+38763333333", false, null, false, "korisnik", false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 1, new DateTime(2025, 11, 12, 13, 57, 22, 239, DateTimeKind.Utc).AddTicks(2052), "", true },
                    { 3, 2, new DateTime(2025, 11, 12, 13, 57, 22, 239, DateTimeKind.Utc).AddTicks(2057), "", true },
                    { 1, 4, new DateTime(2025, 11, 12, 13, 57, 22, 239, DateTimeKind.Utc).AddTicks(2058), "", true }
                });
